...
#         print('inputs ResidualBlock', inputs)
#         print('intermediate_output ResidualBlock', intermediate_output.shape)
        if self.squeeze_and_excitation:
...
#         print('output_sum', output_sum.shape)
...
class ResidualConvBlock(keras.layers.Layer):
    def __init__(self, kernel_number, kernel_size, regularizer=None, strides=1, squeeze_and_excitation=False,
                 kernel_type=None, **kwargs):
#         print(kernel_number, kernel_size, strides)
...
#         print('inputs ResidualConvBlock', inputs)
        intermediate_output = self.resnet_conv_block(inputs, training=training)
#         print('intermediate_output ResidualConvBlock', intermediate_output.shape)
